...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
   <head>
      <title>Trying to display/edit a strand</title>
   </head>
   <body>
<?php
...
print '<form action="handle_form.php" method="POST"> <fieldset><legend>Enter your URL strand:</legend> IDX: <input type="text" name="idx" value="' . $y[0] . '" /><br />';
...
print 'Note: <input type="text" name="Note" value="' . $y[8] . '" size="100"/><br /></fieldset><div align="center"><input type="submit" name="submit" value="Save Changes" /></div></form>';

print '<form action="flub.php" method="POST"><div align="center"><input type="submit" name="submit" value="Cancel" /></div></form>';
	}
//
//
//
...
print '<form action="handle_form.php" method="POST"> <fieldset><legend>Enter your URL strand:</legend> IDX: <input type="text" name="idx" value="000" /><br />';
