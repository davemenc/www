...
$sql = "Select * from flash_lists where flashlistid=$listno and (userno=$userno or userno=0)";
...
function display_cheat($listno){
    ...
    // get image page
    $sql = "Select * from flash_lists where flashlistid=$listno and (userno=0 or userno=$userno)";
    $lists=MYSQLGetData($link,$sql);
 ...
 */
     // get the flash deck
     $sql = "select * from flash_deck where status='Learning' and listno=$listno and (userno=0 or userno=$userno )order by ordval ";
 ...
 // OK, now display that one card
     ...
     $sql = "select flash_deck.cardno,name,image,value from flash_deck,flash_cards where cardid=cardno and  status='Learning' and correct=0 and seen=0 and flash_deck.listno=$listno and flash_deck.userno=flash_cards.userno  and flash_cards.listno=$listno and (flash_cards.userno=0 or flash_cards.userno=$userno) order by ordval limit 1";
