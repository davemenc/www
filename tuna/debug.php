        ...
        if(1==$log_flag){
            ...
            if(isset($array)){
                foreach($array as $key=>$value){
                    ...
                    fwrite($fout,$key);
                    fwrite($fout,"]=>");
		    if (gettype($value)=="array" || gettype($value)=="object" || gettype($value)=="resource" || gettype($value)=="NULL") fwrite($fout,gettype($value));
		    else fwrite($fout,$value);
                }
            }
            fwrite($fout,")\n");
            fflush($fout);
